...
int main()
{
    ...
    typedef MyLib::MyAlloc<DataType> DummyAllocator;
    ...
    PushFrontTest<std::forward_list<DataType, DummyAllocator>> pushFrontForwardListTestDummy;
    printTestStatus("ForwardList PushFront", pushFrontForwardListTestStl, pushFrontForwardListTestFast);
    // printTestStatus("ForwardList PushFront", pushFrontForwardListTestStl, pushFrontForwardListTestDummy);
